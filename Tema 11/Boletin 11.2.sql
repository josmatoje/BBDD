--Boletín 11.2 LeoMetro
USE LeoMetro
GO
--Ejercicio 0
--La convocatoria de elecciones en Madrid ha causado tal conmoción entre los directivos de LeoMetro que han decidido conceder una amnistía a todos 
...
--recargadas al menos una vez en los últimos dos meses.
...
--(opcional). El procedimiento se llamará cuando un pasajero pasa su tarjeta por uno de los tornos de salida del metro. Su misión es grabar la 
--salida en la tabla LM_Viajes. Para ello deberá localizar la entrada que corresponda, que será la última entrada correspondiente al mismo pasajero 
...
--Se recargarán N1 euros a los pasajeros que hayan consumido más de 30 euros en el mes anterior (considerar mes completo, del día 1 al fin) y N2 
--euros a los que hayan utilizado más de 10 veces alguna estación de las zonas 3 o 4.
...
--el código del viaje y la matrícula del tren.
...
--trenes de tipo 2.
--Realiza un procedimiento al que se pase un intervalo de tiempo y modifique la capacidad de todos los trenes que hayan circulado más de una vez 
--por alguna estación de la zona 3 en ese intervalo.